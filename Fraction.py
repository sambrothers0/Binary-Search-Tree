...
class Fraction:
  ...
  def __eq__(self, other):
    ...
    #representation is imprecise. Use cross-
    #multiplication to remain in the integer domain.
    if (self.__n == other.__n) and (other.__d == self.__d):
      return True
    return False
...
if __name__ == '__main__':
  ...
  arr.append(Fraction(1, 2))
  arr.append(Fraction(5, 2))
  arr.append(Fraction(5, 3))
  arr.append(Fraction(6, 2))
  arr.append(Fraction(1, 7))
  arr.append(Fraction(3, 3))
  arr.append(Fraction(8, 9))
  for i in arr:
